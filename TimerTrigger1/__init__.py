...
def main(mytimer: func.TimerRequest) -> None:
    ...
    weekEnding = ct[1].findAll("li")[0].find("a").string # There are two mainText classes, gran the 2nd one, the first list item, the first 'a' tag
    ...
    #logging.info(today, last_saturday, week_ending)
    #logging.info(last_saturday==week_ending)
